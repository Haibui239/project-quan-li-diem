                ...
                <div class="menu-left-list">
                    <ul>
                        ...
                        <li>
                            ...
                            <a href="./thongke.php"><i class="fa-solid fa-address-book"></i>Thống Kê</a></li>
                    </ul>
                </div>
            </div>
            <div class="main flex-wrap">
                <div class="main-container flex-wrap">
                    <div class="main-container-box flex-center shadow">
                        <a href="#" class="main-container-box-text"><p>Sinh Viên</p></a>
                        <div class="layer">
                            <i class="fa-solid fa-graduation-cap"></i>
                        </div>
                    </div>
                    <div class="main-container-box flex-center shadow">
                        <a href="#" class="main-container-box-text"><p>Kết quả</p></a>
                        <div class="layer">
