                ...
                <div class="menu-left-list">
                    <ul>
                        ...
                        <li>
                            ...
                            <a href="./capnhat.php"><i class="fa-solid fa-wrench"></i>Cập Nhật</a></li>
                        <li>
            ...
            <div class="main flex-wrap">
                <div class="main-container flex-wrap">
                    <div class="main-container-box flex-center shadow">
                        <a href="../update-sinhvien/view.php" class="main-container-box-text"><p>Sinh Viên</p></a>
                        <div class="layer">
                            <a href="../update-sinhvien/view.php">
                    ...
                    <div class="main-container-box flex-center shadow">
                        <a href="../update-giaovien/view.php" class="main-container-box-text"><p>Giáo viên</p></a>
                        <div class="layer">
                        <a href="../update-giaovien/view.php">
                            <i class="fa-solid fa-person-chalkboard"></i>
                        </a>
                        </div>
                    </div>
                    <div class="main-container-box flex-center shadow">
                        <a href="../update-monhoc/view.php" class="main-container-box-text"><p>Môn học</p></a>
                        <div class="layer">
                            <a href="../update-monhoc/view.php">
                                <i class="fa-solid fa-book"></i></a>
                        </div>
                    </div>
                    <div class="main-container-box flex-center shadow">
                        <a href="../update-ketqua/view.php" class="main-container-box-text"><p>Kết quả</p></a>
                        <div class="layer">
                            <a href="../update-ketqua/view.php">
