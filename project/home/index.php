        ...
        <div class="container">
            ...
            <div class="menu-left flex-center">
                <div class="menu-left-list">
                    <ul>
                        <li>
                            <a class="active" href="./index.php"><i class="fa-solid fa-house"></i>Trang Chủ</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <a href="./timkiem.php">Tìm Kiếm</a></li>
                        <li>
            ...
            <div class="main flex-wrap">
                <div class="main-container flex-wrap">
                    <div class="main-container-box flex-center shadow">
                        <a  href="home-sinhvien/sinhvien.php" class="main-container-box-text"><p>Sinh Viên</p></a>
                        <div class="layer">
                            <a href="home-sinhvien/sinhvien.php">
                    ...
                    <div class="main-container-box flex-center shadow">
                        <a href="home-sinhvien/khoa.php" class="main-container-box-text"><p>Khoa</p></a>
                        <div class="layer">
                            <a href="home-sinhvien/khoa.php">
                                <i class="fa-solid fa-school-flag"></i>
                            </a>
                        </div>
                    </div>
                    <div class="main-container-box flex-center shadow">
                        <a href="home-sinhvien/giaovien.php" class="main-container-box-text"><p>Giáo viên</p></a>
                        <div class="layer">
                        <a href="home-sinhvien/giaovien.php">
                            <i class="fa-solid fa-person-chalkboard"></i>
                        </a>
                        </div>
                    </div>
                    <div class="main-container-box flex-center shadow">
                        <a href="home-sinhvien/monhoc.php" class="main-container-box-text"><p>Môn học</p></a>
                        <div class="layer">
                            <a href="home-sinhvien/monhoc.php">
                                <i class="fa-solid fa-book"></i>
                            </a>
                        </div>
                    </div>
                    <div class="main-container-box flex-center shadow">
                        <a href="home-sinhvien/ketqua.php" class="main-container-box-text"><p>Kết quả</p></a>
                        <div class="layer">
                            <a href="home-sinhvien/ketqua.php">
                                <i class="fa-solid fa-square-poll-horizontal"></i>
                            </a>
                        </div>
                    </div>
                    <div class="main-container-box flex-center shadow">
                        <a href="home-sinhvien/chitietketqua.php" class="main-container-box-text"><p>Chi tiết kết quả</p></a>
                        <div class="layer">
                            <a href="home-sinhvien/chitietketqua.php">
                ...
                <div class="main-info shadow">
                    ...
                    <div class="main-information width-max">
                        <div class="main-info-text center-row">
                            <a href="profile/index.php"><p>Information</p></a>
                        </div>
                ...
                <div class="main-contact flex-wrap width-max">
                    <div class="main-contact-box flex-wrap p-relative shadow">
                        ...
                        <div class="main-contact-info">
                            <span>Email</span>
                            <a href="mailto:buiviethai2309@gmail.com">
                            <?php
                            $sql = "SELECT id,email FROM users";
                            $result = $conn->query($sql);
                        ?>
                    ...
                    <div class="main-contact-box flex-wrap p-relative shadow">
                        ...
                        <div class="main-contact-info">
                            <span>Twitter</span>
                            <a href="https://twitter.com/PRr2309">@RRr2309</a>
                        </div>  
                        <div class="main-contact-box-hover p-absolute">
                            <i class="fa-solid fa-sort-down"></i>
                        </div>
                    ...
                    <div class="main-contact-box flex-wrap p-relative shadow">
                        ...
                        <div class="main-contact-info">
                            <span>Instagram</span>
                            <a  href="https://www.instagram.com/buiviethai_/">buiviethai_tt</a>
                        </div>
                        <div class="main-contact-box-hover p-absolute">
                            <i class="fa-solid fa-sort-down"></i>
                        </div>
